# IoT-based Indian Sign Language to Speech Device
...
- **Machine Learning**: Custom ISL recognition algorithms
...
- Enabling smoother participation in education and healthcare
...
2. Attach speaker to audio output port
3. Ensure stable power supply
4. Mount device in portable enclosure (optional)

### Software Installation

```bash
# Clone the repository
git clone https://github.com//Grp22-Major-2025/
